...
const COPY = {
  "en-US": {
    ...
    copyMessage: "Copy",
    copyMarkdownMessage: "Copy markdown",
    copyCodeBlock: "Copy code",
    copyBlock: "Copy block",
    imageAttachment: "Image",
    imageAttachmentPreview: "Image preview",
    ...
    messageInputPlaceholder: "Continue this Codex session...",
    sendMessage: "Send",
  ...
  "zh-CN": {
    ...
    copyMessage: "复制",
    copyMarkdownMessage: "复制 Markdown",
    copyCodeBlock: "复制代码",
    copyBlock: "复制块",
    imageAttachment: "图片",
    ...
    messageInputPlaceholder: "继续这个 Codex 会话...",
    sendMessage: "发送",
    sendingMessage: "发送中...",
